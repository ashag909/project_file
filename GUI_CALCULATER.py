...
btn_bracket1.grid(row=5,column=1)
btn_bracket2 = tk.Button(root,text=")", command=lambda: add_to_calculation(")"),width=5, font=("Arial", 14))
btn_bracket2.grid(row=5,column=3)
btn_dot = tk.Button(root,text=".", command=lambda: add_to_calculation("."),width=5, font=("Arial", 16))
btn_dot.grid(row=6,column=1)
btn_equal = tk.Button(root,text="=", command=evaluate_calculation,width=6, font=("Arial", 20))
btn_equal.grid(row=6,column=2,columnspan=2)
btn_clear = tk.Button(root,text="C", command=clear_field,width=5, font=("Arial", 16))
